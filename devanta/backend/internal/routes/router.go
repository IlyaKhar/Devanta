...
func Register(app *fiber.App, s *services.Container) {
	...
	api.Post("/auth/register-parent", auth.RegisterParent)
	...
	api.Post("/tasks/special/:code/claim", middleware.JWTProtected(s.Config.JWTSecret, "student"), learning.ClaimSpecialChallenge)
	...
	api.Get("/parent/connect", parent.PreviewInvite)
	api.Post("/parent/accept-invite", middleware.JWTProtected(s.Config.JWTSecret, "parent"), parent.AcceptInvite)
	api.Get("/parent/children", middleware.JWTProtected(s.Config.JWTSecret, "parent"), parent.ListChildren)
	api.Get("/parent/child/:studentId/progress", middleware.JWTProtected(s.Config.JWTSecret, "parent"), parent.ChildProgress)
	api.Get("/parent/connections", middleware.JWTProtected(s.Config.JWTSecret, "student"), parent.ListConnections)
	api.Delete("/parent/connections", middleware.JWTProtected(s.Config.JWTSecret, "student"), parent.DeleteConnection)
