...
function ProfileUiImg({ src, className = "h-5 w-5" }) {
...
export function ProfilePage() {
    ...
    async function revokeParent(parentUserId) {
        try {
    ...
    return (_jsxs("div", { className: "mx-auto max-w-7xl space-y-4", children: [_jsxs("div", { className: "flex flex-wrap justify-end gap-2", children: [_jsx("button", { type: "button", onClick: () => setTab("overview"), className: `rounded-full px-4 py-1.5 text-sm font-semibold ring-1 ${tab === "overview"
                            ...
                            : "bg-slate-100 text-slate-500 ring-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:ring-slate-700"}`, children: _jsxs("span", { className: "inline-flex items-center gap-2", children: [_jsx(ProfileUiImg, { src: profileUi.overviewTab, className: "h-5 w-5" }), "\u041E\u0431\u0437\u043E\u0440 \u0438 \u0434\u043E\u0441\u0442\u0438\u0436\u0435\u043D\u0438\u044F"] }) }), _jsx("button", { type: "button", onClick: () => setTab("parent"), className: `rounded-full px-4 py-1.5 text-sm font-semibold ring-1 ${tab === "parent"
                            ? "bg-white text-slate-800 ring-slate-200 dark:bg-slate-900 dark:text-slate-100 dark:ring-slate-700"
                            : "bg-slate-100 text-slate-500 ring-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:ring-slate-700"}`, children: _jsxs("span", { className: "inline-flex items-center gap-2", children: [_jsx(ProfileUiImg, { src: profileUi.parentTab, className: "h-5 w-5" }), "\u0420\u043E\u0434\u0438\u0442\u0435\u043B\u044C\u0441\u043A\u0438\u0439 \u043A\u043E\u043D\u0442\u0440\u043E\u043B\u044C"] }) })] }), _jsxs("div", { className: "grid gap-5 xl:grid-cols-[320px_1fr]", children: [_jsxs("section", { className: "space-y-4", children: [_jsxs("article", { className: "rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900", children: [_jsx("div", { className: "mx-auto mb-4 flex h-20 w-20 items-center justify-center overflow-hidden rounded-full bg-brand-100 ring-2 ring-brand-200/60 dark:bg-neutral-900 dark:ring-neutral-700", children: summary?.avatarUrl?.trim() ? (_jsx("img", { src: mediaUrl(summary.avatarUrl), alt: "", className: "h-full w-full object-cover" }, summary.avatarUrl.trim())) : (_jsx(ProfileUiImg, { src: profileUi.avatar, className: "h-11 w-11" })) }), _jsx("h1", { className: "text-center text-2xl font-bold text-slate-900 dark:text-white", children: summary?.fullName?.trim() || "Ученик" }), _jsxs("p", { className: "mt-1 text-center text-sm text-slate-500 dark:text-slate-400", children: ["@", summary?.username?.trim() || "user"] }), _jsx("div", { className: "mt-4 flex justify-center", children: _jsxs("span", { className: "rounded-lg bg-brand-500 px-3 py-1 text-sm font-semibold text-white", children: ["\u0423\u0440\u043E\u0432\u0435\u043D\u044C ", currentLevel] }) }), _jsxs("div", { className: "mt-4", children: [_jsxs("div", { className: "mb-1 flex items-center justify-between text-sm", children: [_jsx("span", { className: "text-slate-500 dark:text-slate-400", children: "\u041F\u0440\u043E\u0433\u0440\u0435\u0441\u0441 \u0443\u0440\u043E\u0432\u043D\u044F" }), _jsxs("span", { className: "font-semibold text-brand-600 dark:text-brand-400", children: [xp, "/", nextLevelXP, " XP"] })] }), _jsx("div", { className: "h-2 rounded-full bg-slate-200 dark:bg-slate-700", children: _jsx("div", { className: "h-2 rounded-full bg-brand-500 transition-all", style: { width: `${progressPercent}%` } }) }), _jsxs("p", { className: "mt-2 text-xs text-slate-500 dark:text-slate-400", children: [Math.max(0, nextLevelXP - xp), " XP \u0434\u043E \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0433\u043E \u0443\u0440\u043E\u0432\u043D\u044F"] })] }), _jsxs("button", { type: "button", onClick: () => navigate("/settings"), className: "mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800", children: [_jsx(ProfileUiImg, { src: profileUi.settings, className: "h-5 w-5" }), "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u043F\u0440\u043E\u0444\u0438\u043B\u044F"] })] }), _jsxs("article", { className: "rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900", children: [_jsx("h2", { className: "mb-3 text-xl font-bold text-slate-900 dark:text-white", children: "\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430" }), _jsxs("ul", { className: "space-y-2 text-sm", children: [_jsxs("li", { className: "flex justify-between text-slate-600 dark:text-slate-300", children: [_jsxs("span", { className: "inline-flex items-center gap-2", children: [_jsx(ProfileUiImg, { src: profileUi.lessonsStat, className: "h-5 w-5" }), "\u0423\u0440\u043E\u043A\u043E\u0432 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u043E"] }), _jsx("b", { children: summary?.lessonsCompleted ?? 0 })] }), _jsxs("li", { className: "flex justify-between text-slate-600 dark:text-slate-300", children: [_jsxs("span", { className: "inline-flex items-center gap-2", children: [_jsx(ProfileUiImg, { src: profileUi.tasksStat, className: "h-5 w-5" }), "\u0417\u0430\u0434\u0430\u0447 \u0440\u0435\u0448\u0435\u043D\u043E"] }), _jsx("b", { children: summary?.tasksSolved ?? 0 })] }), _jsxs("li", { className: "flex justify-between text-slate-600 dark:text-slate-300", children: [_jsxs("span", { className: "inline-flex items-center gap-2", children: [_jsx(ProfileUiImg, { src: profileUi.achievementsStat, className: "h-5 w-5" }), "\u0414\u043E\u0441\u0442\u0438\u0436\u0435\u043D\u0438\u0439"] }), _jsx("b", { children: summary?.achievements ?? 0 })] }), _jsxs("li", { className: "flex justify-between text-slate-600 dark:text-slate-300", children: [_jsxs("span", { className: "inline-flex items-center gap-2", children: [_jsx(ProfileUiImg, { src: profileUi.totalXpStat, className: "h-5 w-5" }), "\u0412\u0441\u0435\u0433\u043E XP"] }), _jsx("b", { children: xp })] })] })] })] }), tab === "overview" ? (_jsxs("section", { className: "space-y-4", children: [_jsxs("article", { className: "rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900", children: [_jsx("h2", { className: "mb-3 text-xl font-bold text-slate-900 dark:text-white", children: "\u041F\u043E\u0441\u043B\u0435\u0434\u043D\u044F\u044F \u0430\u043A\u0442\u0438\u0432\u043D\u043E\u0441\u0442\u044C" }), activity.length === 0 ? (_jsx("p", { className: "text-sm text-slate-500 dark:text-slate-400", children: "\u041F\u043E\u043A\u0430 \u043D\u0435\u0442 \u0430\u043A\u0442\u0438\u0432\u043D\u043E\u0441\u0442\u0438." })) : (_jsx("ul", { className: "space-y-2", children: activity.map((event) => (_jsxs("li", { className: "flex items-start justify-between rounded-xl bg-slate-50 px-3 py-2 dark:bg-slate-800/60", children: [_jsxs("div", { children: [_jsx("p", { className: "font-medium text-slate-900 dark:text-white", children: event.title }), _jsx("p", { className: "text-sm text-slate-500 dark:text-slate-400", children: event.time })] }), _jsx("span", { className: "rounded-md bg-brand-50 px-2 py-0.5 text-xs font-semibold text-brand-700 dark:bg-brand-500/20 dark:text-brand-300", children: event.xp })] }, `${event.title}-${event.time}-${event.xp}`))) }))] }), _jsxs("article", { className: "rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900", children: [_jsx("h2", { className: "text-xl font-bold text-slate-900 dark:text-white", children: "\u0422\u0432\u043E\u0438 \u0434\u043E\u0441\u0442\u0438\u0436\u0435\u043D\u0438\u044F" }), _jsxs("p", { className: "mb-4 text-sm text-slate-500 dark:text-slate-400", children: ["\u041F\u043E\u043B\u0443\u0447\u0435\u043D\u043E: ", summary?.achievements ?? 0] }), achievementItems.length === 0 ? (_jsx("p", { className: "text-sm text-slate-500 dark:text-slate-400", children: "\u0414\u043E\u0441\u0442\u0438\u0436\u0435\u043D\u0438\u0439 \u043F\u043E\u043A\u0430 \u043D\u0435\u0442." })) : (_jsx("div", { className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-3", children: achievementItems.map((item) => (_jsxs("div", { className: "rounded-xl border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-900", children: [_jsx("p", { className: "text-sm font-semibold text-slate-900 dark:text-white", children: item.title }), _jsx("p", { className: "mt-1 text-xs text-slate-500 dark:text-slate-400", children: item.date }), _jsx("div", { className: "mt-2 inline-flex rounded-md bg-brand-50 px-2 py-0.5 text-[11px] font-semibold text-brand-700 dark:bg-brand-500/20 dark:text-brand-300", children: item.code })] }, item.code + item.date))) }))] })] })) : (_jsx("section", { className: "space-y-4", children: _jsxs("article", { className: "rounded-2xl border border-blue-200 bg-blue-50/40 p-5 shadow-sm dark:border-blue-500/30 dark:bg-blue-500/5", children: [_jsx("h2", { className: "text-2xl font-bold text-slate-900 dark:text-white", children: "\u041F\u043E\u0434\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0435 \u0440\u043E\u0434\u0438\u0442\u0435\u043B\u0435\u0439" }), _jsx("p", { className: "mt-1 text-sm text-slate-500 dark:text-slate-400", children: "\u041E\u0442\u043F\u0440\u0430\u0432\u044C \u0441\u0441\u044B\u043B\u043A\u0443 \u0440\u043E\u0434\u0438\u0442\u0435\u043B\u044E \u2014 \u0435\u043C\u0443 \u043D\u0443\u0436\u0435\u043D \u0430\u043A\u043A\u0430\u0443\u043D\u0442 \u00AB\u0440\u043E\u0434\u0438\u0442\u0435\u043B\u044C\u00BB; \u043F\u043E \u0441\u0441\u044B\u043B\u043A\u0435 \u043F\u0440\u0438\u0432\u044F\u0437\u043A\u0430 \u043A \u0435\u0433\u043E \u043B\u043E\u0433\u0438\u043D\u0443 \u0438 \u043F\u0440\u043E\u0433\u0440\u0435\u0441\u0441 \u0432 \u041B\u041A." }), _jsxs("div", { className: "mt-4 flex flex-wrap gap-2", children: [_jsxs("button", { type: "button", onClick: copyInviteLink, className: "inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800", children: [_jsx(ProfileUiImg, { src: profileUi.copyLink, className: "h-5 w-5" }), "\u041A\u043E\u043F\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0441\u0441\u044B\u043B\u043A\u0443"] }), _jsxs("button", { type: "button", onClick: shareInviteLink, className: "inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800", children: [_jsx(ProfileUiImg, { src: profileUi.share, className: "h-5 w-5" }), "\u041F\u043E\u0434\u0435\u043B\u0438\u0442\u044C\u0441\u044F"] })] }), _jsx("div", { className: "mt-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs break-all text-slate-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-400", children: isInviteLoading ? "Генерирую ссылку-приглашение..." : inviteLink || "Ссылка появится здесь после загрузки." }), inviteNotice ? (_jsx("p", { className: "mt-2 text-sm font-medium text-brand-600 dark:text-brand-400", children: inviteNotice })) : null, _jsxs("div", { className: "mt-4", children: [_jsx("h3", { className: "text-sm font-semibold text-slate-800 dark:text-slate-200", children: "\u041F\u043E\u0434\u043A\u043B\u044E\u0447\u0451\u043D\u043D\u044B\u0435 \u0440\u043E\u0434\u0438\u0442\u0435\u043B\u0438" }), isConnectionsLoading ? (_jsx("p", { className: "mt-2 text-sm text-slate-500", children: "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430..." })) : parentConnections.length === 0 ? (_jsx("p", { className: "mt-2 text-sm text-slate-500 dark:text-slate-400", children: "\u041F\u043E\u043A\u0430 \u043D\u0438\u043A\u0442\u043E \u043D\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u043B \u043F\u0440\u0438\u0433\u043B\u0430\u0448\u0435\u043D\u0438\u0435." })) : (_jsx("ul", { className: "mt-2 space-y-2", children: parentConnections.map((p) => (_jsxs("li", { className: "flex flex-wrap items-center justify-between gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm dark:border-slate-700 dark:bg-slate-900", children: [_jsx("span", { className: "text-slate-800 dark:text-slate-200", children: p.parentEmail }), _jsx("button", { type: "button", onClick: () => revokeParent(p.parentUserId), className: "rounded-lg border border-red-200 px-2 py-1 text-xs font-semibold text-red-600 hover:bg-red-50 dark:border-red-900 dark:text-red-400 dark:hover:bg-red-950/40", children: "\u041E\u0442\u043A\u043B\u044E\u0447\u0438\u0442\u044C" })] }, p.parentUserId))) }))] }), qrImageUrl ? (_jsx("div", { className: "mt-4 inline-flex rounded-2xl bg-white p-3 shadow-sm dark:bg-slate-900", children: _jsx("img", { src: qrImageUrl, alt: "QR-\u043A\u043E\u0434: \u0441\u0441\u044B\u043B\u043A\u0430 \u0434\u043B\u044F \u0440\u043E\u0434\u0438\u0442\u0435\u043B\u044F", className: "h-56 w-56 rounded-xl object-contain" }) })) : null] }) }))] })] }));
}
